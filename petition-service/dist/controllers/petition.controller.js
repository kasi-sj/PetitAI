...
const petitionServices = __importStar(require("../services/petition.services"));
const getAllPetitions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield petitionServices.getAllPetitions(req, res);
    }
    catch (error) {
        console.log(error);
...
const getPetitionById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield petitionServices.getPetitionById(req, res);
    }
    catch (error) {
        console.log(error);
        res.status(400).json({ message: error.message });
...
const createPetition = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield petitionServices.createPetition(req, res);
    }
    catch (error) {
        console.log(error);
        res.status(400).json({ message: error.message });
...
const updatePetition = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield petitionServices.updatePetition(req, res);
    }
    catch (error) {
        console.log(error);
        res.status(400).json({ message: error.message });
...
const deletePetition = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield petitionServices.deletePetition(req, res);
    }
    catch (error) {
        console.log(error);
        res.status(400).json({ message: error.message });
